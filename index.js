 ...
 * <ul>
 * <li> `browser:uncompressed` - build uncomprssed browser bundle (`solarcore-*.js`)
 * <li> `browser:compressed` - build compressed browser bundle (`solarcore-*.min.js`)
...
function startGulp(name, opts) {
  ...
  var fullname = name ? 'solarcore-' + name : 'solarcore';
  var files = ['lib/**/*.js'];
  var tests = ['test/**/*.js'];
  var alljs = files.concat(tests);

  var buildPath = './node_modules/solarcore-build/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external solarcore-lib -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:solarcore-lib -o solarcore-lib.js';
    }
